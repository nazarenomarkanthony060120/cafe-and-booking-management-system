...
const UserSidebar = ({ setCurrentSection }: { setCurrentSection: Dispatch<SetStateAction<string>> }) => {
            ...
            <div className='mt-4 flex flex-col gap-4 relative'>
                {
                    ...
                    <div key={i} className={`flex items-center gap-4 p-2 cursor-pointer hover:bg-gray-700 hover:text-white group rounded-md ${open ? 'pl-4' : 'pl-2'}`}
                        onClick={() => {
