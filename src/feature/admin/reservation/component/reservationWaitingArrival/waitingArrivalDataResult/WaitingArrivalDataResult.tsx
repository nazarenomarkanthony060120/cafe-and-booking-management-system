...
interface WaitingArrivalDataResultProps {
    reservationData: ReservationData
    expectedArrivalTime: string
}

export const WaitingArrivalDataResult = ({
    reservationData,
}: WaitingArrivalDataResultProps) => {
    return (
        <div className="space-y-3">
            ...
            <div>
                <label className="text-gray-600 text-sm">Expected Arrival Time</label>
                <input
                    className="w-full p-2 border rounded mt-1 text-sm"
