...
interface WaitingArrivalButtonProps {
    handleCompleteReservation: () => void
    handleIncompleteReservation: () => void
    loadingType: "complete" | "incomplete" | null
}

export const WaitingArrivalButton = ({
    handleCompleteReservation,
    handleIncompleteReservation,
    loadingType,
}: WaitingArrivalButtonProps) => {
    return (
        <div className="grid grid-cols-2 gap-4 mt-6">
            ...
            <button
                ...
                onClick={handleIncompleteReservation}
                disabled={loadingType !== null}
            >
                {loadingType === "incomplete" ? (
                    <svg
                        className="animate-spin h-5 w-5 text-white"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
