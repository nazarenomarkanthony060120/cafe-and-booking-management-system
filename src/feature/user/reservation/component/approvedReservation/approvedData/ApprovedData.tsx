...
export const ApprovedData = ({ reservationData }: ApprovedDataProps) => {
    return (
        <div className="space-y-3">
            ...
            <div>
                <label className="text-gray-600 text-sm">Approved Date</label>
                <input
                    className="w-full p-2 border rounded mt-1 text-sm"
                    value={reservationData.approved_date}
                    readOnly
                />
            </div>
        </div>
